...
将 `[skill名称]` 替换成 `prompt-architect`、`code-assistant-skill`、`mercadolibre-advisor`、`fund-analysis-advisor`、`travel-planner`、`family-kitchen-tutor` 或 `dabaihua-chat-partner`。AI 助手会自动从 GitHub 下载对应文件夹并安装到正确位置。
